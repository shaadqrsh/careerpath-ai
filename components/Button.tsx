...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // Primary: Gradient blue (Consistent in both, slightly brighter in dark)
    ...
    // Secondary: Light Gray in Light Mode, Dark Slate in Dark Mode
    ...
    // Outline: Slate borders, text adapts to theme
    ...
    // Ghost: Transparent background, text adapts
